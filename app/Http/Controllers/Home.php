...
//        dd($this->getSearchFilterOptionsForView());
    ...
    public function sendRepairIssue(Request $request) {
        ...
        // echo $message;  
        Mail::to('property.management@guardsrealestate.com')
        ->cc(['info@guardsrealestate.com'])
        ->send(new Repair($message, $images));
    ...
    public function sendValuationMail(Request $request) {
        ...
        if(is_array($request->all())) {
            Mail::to('nathan.dicarlo@guardsrealestate.com')
            ->cc(['info@guardsrealestate.com'])
            ->send(new BookValuation($request->all()));
        }
    ...
    public function sendHomeValuationMail(Request $request) {
        ...
        if(is_array($request->all())) {
            Mail::to('nathan.dicarlo@guardsrealestate.com')
            ->cc(['info@guardsrealestate.com'])            
            ->send(new HomeBookValuation($request->all()));
        }
