        ...
        <div class="about-us">
            <div class="privacy-container">
                <div class="container">
                    ...
                    <a class="btn-guards full-width"  href="{{asset('files/Propertymark+Certificate.pdf')}}" title="Guards - Client Money Protection Scheme" target="_blank">CLIENT MONEY PROTECTION SCHEME</a>
