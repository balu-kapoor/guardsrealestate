        ...
        <div class="about-us">
            <div class="privacy-container">
                <div class="container">
                    ...
                    <a class="btn-guards full-width"  href="{{asset('files/Propertymark+Certificate2.pdf')}}" title="Guards - Client Money Protection Scheme" target="_blank">CLIENT MONEY PROTECTION SCHEME</a>
                    ...
                    <a class="btn-guards full-width"  href="{{asset('files/PRS-Certificate-23.pdf')}}" title="Guards - Property Redress Scheme" target="_blank">PROPERTY REDRESS SCHEME MEMBERSHIP</a>
