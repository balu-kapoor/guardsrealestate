...
@section('page-body')
    ...
    <main>
        <div class="main-heading-row">
            <img src="{{ asset('images/payments.jpg')}}" class="responsive-img ">
                            ...
                            <div class="form-block">
                                <div class="row">
                                    <form class="col s12" id="sage_pay"
                                        ...
                                        <input type="hidden" name="Vendor" value="{{SAGE_VENDOR_NAME}}">
                                        <input type="hidden" name="Crypt" id="crypt_value" value="">
                                        <input type="hidden" name="FailureURL" value="{{route('website-payments').'?failure'}}">
                                        <input type="hidden" name="SuccessURL" value="{{route('website-payments').'?success'}}">
