                    ...
                    <div class="input_wrapper">
                        <div class="input_container">
                            <div class="results_wrapper false"><div>
                                ...
                                <p class="ylw">For more information about what to expect from a home visit valuation, and how we are conducting them safely, <a href="{{ url('contact-us') }}" target="_blank" style="color: rgb(255, 255, 255);">contact here</a>.</p></div></div></div></div></div>           
            </div>
