...
<?php $__env->startSection('page-body'); ?>
    <main>
        ...
        <div class="main-heading-row">
            <!-- <img src="<?php echo e(asset('images/serviceNew.jpg')); ?>" class="responsive-img "> -->
        ...
        <form id="repair-form" action="<?php echo e(route('send-repair-issue')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="all_steps first-step">
                ...
                <div class="form"><?php echo $__env->make('includes.forms', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></div>
            ...
            <div class="all_steps fifth-step" style="display: none;">
                <?php echo $__env->make('includes.confirm-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <div class="bar">
...
<script src="<?php echo e(asset('js/plugins/multi.upload.js')); ?>"></script>
    <script>
        const api_url = "<?php echo e(url('/')); ?>/getRepairData";
        const sub_cat = "<?php echo e(url('/')); ?>/getSubCategory";
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\guardsre-web\resources\views/pages/repair.blade.php ENDPATH**/ ?>