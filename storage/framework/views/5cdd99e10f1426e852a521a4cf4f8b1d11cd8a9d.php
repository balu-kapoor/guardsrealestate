...
<?php $__env->startSection('page-body'); ?><main class="privacy">
    <div class="main-heading-row">
        <img  src="<?php echo e(asset('images/guardsmanagement.jpg')); ?>"  class="responsive-img ">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\guardsre-web\resources\views//pages/guards-protection-management.blade.php ENDPATH**/ ?>