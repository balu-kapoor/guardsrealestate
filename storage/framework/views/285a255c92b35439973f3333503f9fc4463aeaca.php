...
<html lang="en">
	<head>
		...
		<title>Home | Guards Country</title>
		...
		<link rel="shortcut icon" href="https://fabrum.nz/guards/public/country.png">
	...
	<body>
		...
		<div class="global-overlay">
			<div class="overlay-inner bg-image-holder bg-cover zoom-animation">
				<img src="https://fabrum.nz/guards/public/bg.jpg" alt="background">
			</div>
		...
		<div class="site-container">
			...
			<header class="site-header header-fixed d-flex justify-content-center">
				<!-- Logo -->
				<a href="<?php echo e(url('/')); ?>" class="logo_header">
			...
			<section id="home" class="d-flex min-vh--100">
				<div class="container align-self-center text-white">
					...
					<div class="text-center"><a href="<?php echo e(url('/')); ?>?location=true" class="btn-guards">Find Your Home</a></div>
			...
			<footer class="site-footer footer-fixed footer-mobile-dark footer-light">
				<div class="container-fluid align-items-md-center justify-content-md-between btm_footer">
					...
					<div style="margin-top: 3rem;">
						...
						<br>
						<p style="color: #fff !important">T +44 01642 687 188</p>
					</div>
...
<?php /**PATH C:\xampp\htdocs\guardsre-web\resources\views/pages/country.blade.php ENDPATH**/ ?>