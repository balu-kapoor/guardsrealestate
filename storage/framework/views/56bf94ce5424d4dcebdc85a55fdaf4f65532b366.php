...
<a href="<?php echo e(url('valuation/online')); ?>" class="valuation__pop">Book Valuation</a>
<a href="https://api.whatsapp.com/send?phone=447487860937" id="whatsapp_call_button" target="_blank">
...
<script type="text/javascript" src="<?php echo e(asset('js/plugins/jquery.visible.js')); ?>"></script>
...
var FILTEROPTIONS = <?php echo json_encode($filterOptions); ?>;
    ...
    jQuery(function () {
        ...
        jQuery('form#viewing_form').submit(function (e) {
            ...
            $.post('<?php echo e(route('api-bookviewing')); ?>',$formdata,function (response)
            {
        ...
        jQuery('form#book-valuation-form-el').submit(function (e) {
            ...
            $.post('<?php echo e(route('api-bookvaluation')); ?>',$formdata,function (response)
            {
...
<?php /**PATH C:\xampp\htdocs\guardsre-web\resources\views/layout.blade.php ENDPATH**/ ?>