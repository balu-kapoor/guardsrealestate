<header  role="banner"><div class="navbar-fixed">
        ...
        <nav class="valign-wrapper">
            <div class="container">
                <div id="slide-out" class="sidenav menu">
                    <div class="menu-logo">
                        <img src="<?php echo e(asset('images/full_logo.svg')); ?>" >
                        <a href="tel:+442036331271" class="m-text" style="line-height: 1rem;padding-bottom: 30px;display: block">+44 (0) 20 3633 1271</a>
                    </div>
                    <ul class="collapsible">
                        <li style=" -webkit-animation-duration: .5s;animation-duration:.5s;"><a href="<?php echo e(route('website-home')); ?>" class="selected-nav ">Home</a>
                        </li>                       
                        <li style=" -webkit-animation-duration: .7s;animation-duration: .7s;">
                            ...
                            <ul class="collapsible-body">
                                <li><a href="<?php echo e(route('website-property-search')); ?>?list=L">Properties to Let</a></li>
                        ...
                        <li style=" -webkit-animation-duration: .9s;animation-duration: .9s;">
                            ...
                            <ul class="collapsible-body">
                                <li><a href="<?php echo e(route('website-property-search')); ?>?list=S">Properties for Sale</a></li>
                                <li><a  href="/payments">Make An Offer</a></li>
                            </ul>
                        </li>
                        ...
                        <li style=" -webkit-animation-duration: 1.6s;animation-duration: 1.6s;"><a href="<?php echo e(route('repair-maintenance')); ?>">Report a repair</a></li>
    ...
    <!--                       <li style=" -webkit-animation-duration: 1.4s;animation-duration: 1.4s;">
                        ...
                        <li style=" -webkit-animation-duration: 1.6s;animation-duration: 1.6s;"><a href="<?php echo e(route('website-contact')); ?>">Get in touch</a></li>
                    </ul>
                </div>
                ...
                <a href="<?php echo e(route('website-home')); ?>" class="brand-logo center valign-wrapper">
                    <img src="<?php echo e(asset('images/horseicon.svg')); ?>" class="horse" id="hd-logo">
                </a>
                ...
                <!-- <div class="right" style="  line-height: 30px; text-align: center;">
                    <a class="btn-guards" href="<?php echo e(url('valuation/online')); ?>" style="display: block;margin-top:20px;">Book valuation</a>
                </div> -->
            </div>
        </nav>
    </div>
...
<?php /**PATH C:\xampp\htdocs\guardsre-web\resources\views/includes/navigation.blade.php ENDPATH**/ ?>